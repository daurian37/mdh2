...
<div class="container-fluid p-5">
          ...
          <h2 style="text-align:center;color:green" class="col-lg-4 offset-4">Inscription Espace Pro</h2> <br><br>
...
if(isset($errors) && count($errors) !=0 ){
 ...
 ?>
            ...
            <form form class="col-lg-4 offset-4" action="enregistrement_inscription_pro.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
              <label for="profession"><b>Êtes vous professionnel ? :</b></label>
          <label class="checkbox">
<input id="profession" name="profession" type="checkbox"
value="Soignant">
Soignant</label>
        <label class="checkbox">
<input id="profession" name="profession" type="checkbox"
...
<div class="form-group">
             <label for="attestation"><b>Joindre une attestation de votre profession (format "PDF" moins de "2 Mo")  :</b></label>
            <input  type="file" name="attestation" id = "attestation" required="required">
                </div>
...
<!--                 <label class="custom-file-label" for="avatar">format "JPG" moins de "2 Mo"</label>
 -->              </div><br>
        ...
        <p><h5>Vous n'êtes pas professionnel ? Inscrivez-vous dans <a href="page_inscription.php" class="lien"> l'Espace non professionnel</a></h5></p>
